...
|---|---|---|
| `ts/` | @voxgig-sdk/uv-index-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/uv-index-sdk \
      --repository voxgig-sdk/uv-index-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/uv-index-sdk` shows it, and
`npm trust revoke @voxgig-sdk/uv-index-sdk --id=<id>` removes it.
