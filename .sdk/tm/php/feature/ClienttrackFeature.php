...
// UvIndex SDK clienttrack feature
...
class UvIndexClienttrackFeature extends UvIndexBaseFeature
{
    ...
    public function PostConstruct(UvIndexContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UvIndex-SDK';
