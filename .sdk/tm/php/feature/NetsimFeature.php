...
class UvIndexNetsimFeature extends UvIndexBaseFeature
{
    ...
    private function _simulate(UvIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UvIndexContext $ctx, array $applied): void
    {
        $client = $this->client;
