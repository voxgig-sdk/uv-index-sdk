...
// UvIndex SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class UvIndexTestFeature extends UvIndexBaseFeature
{
    ...
    public function init(UvIndexContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (UvIndexContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (UvIndexContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(UvIndexContext $ctx, $op, $args): array
    {
