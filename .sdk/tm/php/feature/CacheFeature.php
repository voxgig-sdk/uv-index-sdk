...
class UvIndexCacheFeature extends UvIndexBaseFeature
{
    ...
    private function _through(UvIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
