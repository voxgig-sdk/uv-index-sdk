...
// UvIndex SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UvIndexMakeRequest
{
    public static function call(UvIndexContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UvIndexResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UvIndexResponse($fetched);
        } else {
