...
// UvIndex SDK utility: fetcher

class UvIndexFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UvIndexSDK/1.0)';
    ...
    public static function call(UvIndexContext $ctx, string $fullurl, array $fetchdef): array
    {
