...
from projectname_sdk.core.control import UvIndexControl
...
class UvIndexContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, UvIndexResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UvIndexError(code, msg, self)
