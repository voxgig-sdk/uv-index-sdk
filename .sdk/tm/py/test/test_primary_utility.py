...
from projectname_sdk import UvIndexSDK
from projectname_sdk.core.spec import UvIndexSpec
from projectname_sdk.core.result import UvIndexResult
from projectname_sdk.core.response import UvIndexResponse
from projectname_sdk.core.operation import UvIndexOperation
from projectname_sdk.core.error import UvIndexError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import UvIndexBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = UvIndexSDK.test(None, None)
        ...
        class TestInitFeature(UvIndexBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(UvIndexBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = UvIndexSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = UvIndexSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = UvIndexSDK.test(None, setup_opts)
