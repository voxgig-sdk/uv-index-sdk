...
class UvIndexTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UvIndexTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UvIndexTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UvIndexTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
