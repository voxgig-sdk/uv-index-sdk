...
class UvIndexTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UvIndexTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UvIndexTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UvIndexTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
