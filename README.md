...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/uv-index` | `npm install @voxgig-sdk/uv-index` |
| Python | `voxgig-sdk-uv-index` | `pip install voxgig-sdk-uv-index` |
| PHP | `voxgig-sdk/uv-index` | `composer require voxgig-sdk/uv-index` |
| Golang | `github.com/voxgig-sdk/uv-index-sdk/go` | `go get github.com/voxgig-sdk/uv-index-sdk/go` |
| Ruby | `voxgig-sdk-uv-index` | `gem install voxgig-sdk-uv-index` |
| Lua | `voxgig-sdk-uv-index` | `luarocks install voxgig-sdk-uv-index` |
