...
class UvIndexTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UvIndexTestRunner.getenv("UVINDEX_TEST_LIVE")
        override = UvIndexTestRunner.getenv("UVINDEX_TEST_OVERRIDE")
        ...
        explain = UvIndexTestRunner.getenv("UVINDEX_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["UVINDEX_TEST_EXPLAIN"] = explain
