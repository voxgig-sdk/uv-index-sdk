# UvIndex SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UvIndexSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UvIndexSDK(...) and UvIndexSDK.test(...) become
#      UvIndexSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "uvindex_sdk"
_SDK_CLASS = "UvIndexSDK"
