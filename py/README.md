...
The Python SDK for the UvIndex API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.UvIndex()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/uv-index-sdk/releases)) or
...
```
py/
├── uvindex_sdk.py         -- Main SDK module
