...
func registerSDKWords(r *eng.Registry, client *sdk.UvIndexSDK) {
...
func runOp(client *sdk.UvIndexSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
