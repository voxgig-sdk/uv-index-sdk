...
type Args struct {
	Entity string         `json:"entity" jsonschema:"uv_index"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UvIndexSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "uv-index_list",
		Description: "List records from UvIndex. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "uv-index_load",
		Description: "Load a single record from UvIndex. " +
...
func runOp(client *sdk.UvIndexSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UvIndexSDK, name string) (sdk.UvIndexEntity, error) {
	switch strings.ToLower(name) {
	case "uv_index":
		return client.UvIndex(nil), nil
