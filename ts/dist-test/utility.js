...
function envOverride(m) {
    if ('TRUE' === process.env.UV_INDEX_TEST_LIVE ||
        'TRUE' === process.env.UV_INDEX_TEST_OVERRIDE) {
    ...
    m.UV_INDEX_TEST_EXPLAIN = process.env.UV_INDEX_TEST_EXPLAIN || m.UV_INDEX_TEST_EXPLAIN;
    return m;
}
