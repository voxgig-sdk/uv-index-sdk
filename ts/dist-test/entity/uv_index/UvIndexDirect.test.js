...
(0, node_test_1.describe)('UvIndexDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-uv_index', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-uv_index', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.UV_INDEX_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UvIndexSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['UV_INDEX_TEST_UV_INDEX_ENTID'];
    ...
    const client = new __1.UvIndexSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=UvIndexDirect.test.js.map