...
import { UvIndexSDK, BaseFeature, stdutil } from '../../..'
...
describe('UvIndexEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let uv_index_ref01_data = Object.values(setup.data.existing.uv_index)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/uv_index/UvIndexTestData.json')
  ...
  let client = UvIndexSDK.test(options, extra)
