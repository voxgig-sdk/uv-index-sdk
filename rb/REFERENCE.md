# UvIndex Ruby SDK Reference

Complete API reference for the UvIndex Ruby SDK.
...
#### `UvIndexSDK.test(testopts = nil, sdkopts = nil)`
...
| `resources` | `Array` | No |  |
| `title` | `String` | No |  |
| `total` | `Integer` | No | Total number of records available |
