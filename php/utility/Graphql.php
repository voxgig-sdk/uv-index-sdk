...
class UvIndexGraphql
{
    ...
    // equivalent.
    public static function body(UvIndexContext $ctx): mixed
    {
    ...
    public static function errors(UvIndexContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
