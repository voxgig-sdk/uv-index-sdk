...
The PHP SDK for the UvIndex API — an entity-oriented client using PHP conventions.
...
```
php/
├── uvindex_sdk.php          -- Main SDK class
...
The main class (`uvindex_sdk.php`) exports the SDK class
