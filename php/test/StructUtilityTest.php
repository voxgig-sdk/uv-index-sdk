...
// UvIndex SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UvIndexOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UvIndexOmni::structfix($now, Struct::undef()))
                        !== json_encode(UvIndexOmni::structfix($val, Struct::undef()))) {
