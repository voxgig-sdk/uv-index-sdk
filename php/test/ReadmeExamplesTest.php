...
// UvIndex SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UvIndexSDK::test)
...
{
    private const SDK_CLASS = 'UvIndexSDK';
    ...
    private const SDK_BASE = 'uvindex_sdk';
