...
class UvIndexRbacFeature extends UvIndexBaseFeature
{
    ...
    private function _required(UvIndexContext $ctx): ?string
    {
    ...
    private function _reject(UvIndexContext $ctx, string $required): void
    {
    ...
    private function _track(UvIndexContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
