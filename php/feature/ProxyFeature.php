...
class UvIndexProxyFeature extends UvIndexBaseFeature
{
    ...
    public function init(UvIndexContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UvIndexContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
