...
class UvIndexStreamingFeature extends UvIndexBaseFeature
{
    ...
    private function _iterate(UvIndexResult $result): \Generator
    {
    ...
    private function _streamable(UvIndexContext $ctx): bool
    {
