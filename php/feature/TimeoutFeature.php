...
class UvIndexTimeoutFeature extends UvIndexBaseFeature
{
    ...
    private function _with_timeout(UvIndexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UvIndexContext $_ctx, float $ms): void
    {
        $client = $this->client;
