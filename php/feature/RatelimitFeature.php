...
class UvIndexRatelimitFeature extends UvIndexBaseFeature
{
    ...
    private function _acquire(UvIndexContext $ctx): void
    {
    ...
    private function _track(UvIndexContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
