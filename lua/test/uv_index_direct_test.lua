...
describe("UvIndexDirect", function()
  it("should direct-load-uv_index", function()
    local setup = uv_index_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-uv_index", setup.live and "live" or "unit")
...
function uv_index_direct_setup(mockres)
