...
import (
	...
	vs "github.com/voxgig-sdk/uv-index-sdk/go/utility/struct"
)

type UvIndexEntity struct {
	name    string
	client  *core.UvIndexSDK
...
func NewUvIndexEntity(client *core.UvIndexSDK, entopts map[string]any) *UvIndexEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UvIndexEntity) GetName() string { return e.name }
...
func (e *UvIndexEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UvIndexEntity) Deleted() bool {
	return e.deleted
}


func (e *UvIndexEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUvIndexEntity(e.client, opts)
}

func (e *UvIndexEntity) Data(args ...any) any {
...
func (e *UvIndexEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UvIndex; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UvIndexEntity) DataTyped(data ...UvIndex) UvIndex {
	if len(data) > 0 {
		return typedFrom[UvIndex](e.Data(asMap(data[0])))
	}
	return typedFrom[UvIndex](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UvIndex (all fields
// optional at the wire level).
func (e *UvIndexEntity) MatchTyped(match ...UvIndex) UvIndex {
	if len(match) > 0 {
		return typedFrom[UvIndex](e.Match(asMap(match[0])))
	}
	return typedFrom[UvIndex](e.Match())
}
...
func (e *UvIndexEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UvIndexEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UvIndexLoadMatch and returns an UvIndex. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UvIndexEntity) LoadTyped(reqmatch UvIndexLoadMatch, ctrl map[string]any) (UvIndex, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UvIndex{}, err
	}
	return typedFrom[UvIndex](res), nil
}



func (e *UvIndexEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UvIndexEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UvIndexEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UvIndexEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UvIndexEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
