...
func (sdk *UvIndexSDK) OptionsMap() map[string]any {
...
func (sdk *UvIndexSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UvIndexSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UvIndexSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UvIndexSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UvIndexSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UvIndexSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UvIndexSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UvIndexSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UvIndexSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UvIndexSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
